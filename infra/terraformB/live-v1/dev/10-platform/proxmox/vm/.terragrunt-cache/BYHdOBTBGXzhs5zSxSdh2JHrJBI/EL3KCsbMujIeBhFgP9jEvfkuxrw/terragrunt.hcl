...
dependency "sdn" {
  ...
  # Optional: Add mock outputs for terragrunt validate/plan
  mock_outputs = {
    zone_bridge = "vmbr0"
    vnet_details = {
      vnetdev1 = {
...
inputs = {
  ...
  os_family = "linux"
  os_name   = "rocky-10"  # Changed from ubuntu-24.04
  ...
  cpu_cores    = 2
  memory_mb    = 4096
  disk_size_gb = 40  # This will be ignored for now since we removed disk block
