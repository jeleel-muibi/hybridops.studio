// file: infra/terraform/live-v1/staging/10-platform/proxmox/vm/terragrunt.hcl
// purpose: Proxmox VM cluster for staging environment
...
locals {
  vnet           = dependency.sdn.outputs.vnet_names["vnet-staging-linux"]
  vm_name_prefix = "staging-k3s-"
}
...
inputs = {
  ...
  extra_tags = ["terraform", "k3s", "staging"]
}
