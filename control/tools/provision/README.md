...
> **Documentation:** [HOWTO – Packer + Proxmox templates](https://docs.hybridops.studio/howtos/packer-proxmox-template/) · [Runbook – Proxmox VM template build](https://docs.hybridops.studio/runbooks/platform/packer-proxmox-template-build/) · [ADR-0016 – Packer + Cloud-Init VM templates](https://docs.hybridops.studio/adr/ADR-0016-packer-cloudinit-vm-templates/)
...
- `output/artifacts/platform/packer-builds/init/<timestamp>/` (when `evidence_packer.sh` is available)
...
- Creates a timestamped folder under `output/artifacts/platform/packer-builds/`.
...
- Proof artifacts under `output/artifacts/platform/packer-builds/`
...
grep -R "${CHAIN_ID}" output/artifacts/platform/packer-builds
```
...
- [ADR-0016 – Packer + Cloud-Init VM Templates](https://docs.hybridops.studio/adr/ADR-0016-packer-cloudinit-vm-templates/)
- [Runbook – Proxmox VM Template Build](https://docs.hybridops.studio/runbooks/platform/packer-proxmox-template-build/)
- [HOWTO – First Packer Template](https://docs.hybridops.studio/howtos/packer-proxmox-template/)
